...
const Details = () => {
    ...
    return (
        <div>
            ...
            <h2 className="flex justify-center text-3xl mt-10 font-semibold text-red-500  ml-4 mr-4 mb-2">Everything you need to know about: '{name}'</h2><Pdf targetRef={ref} filename="Course-details.pdf">
            ...
            <section className='max-w-[840px] mx-auto' ref={ref}>
                ...
                <div className='flex my-4 lg:mx-24'>
                    <Link to={`/checkout/${id}`}><button className="mx-auto ml-4 block p-3 text-center rounded-xl mt-4 text-white bg-red-500 hover:bg-red-600">Get Premium Access</button></Link>
                    <Link to={'/courses'}><button className="mx-auto block p-3 text-center rounded-xl mt-4 ml-2 mr-4 text-white bg-red-500 hover:bg-red-600">Back to Courses</button></Link>
                </div>
            </section>
        </div>
    );
